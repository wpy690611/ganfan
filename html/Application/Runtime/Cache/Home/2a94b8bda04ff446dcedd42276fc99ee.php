...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?9f65e5309ae187eea0690a4a03cc5c18";
...
(function() {
  var hm = document.createElement("script");
  hm.src = "https://hm.baidu.com/hm.js?0dd58de9da626ea5ed18d5cf69ac8181";
  var s = document.getElementsByTagName("script")[0]; 
  s.parentNode.insertBefore(hm, s);
})();
</script>
...
<body style="margin: 0; font-family: SimHei;">
    <div style="background-image: url(/Public/Home/ganfanc/static/images/1_2.jpg); background-position: center; height: 253px;">
    </div>
    <div id="gotop" style="background-image: url(/Public/Home/ganfanc/static/images/2_2.jpg); background-position: center;
        height: 253px;">
    </div>
    <div style="background-image: url(/Public/Home/ganfanc/static/images/3_2.jpg); background-position: center; height: 253px;">
        <div style="width: 1132px; background: rgba(0,0,0,0); margin: 0 auto; padding-top: 16px;">
            <div id="flashborder" style="width: 413px; height: 150px; float: right; box-sizing: border-box;">
                <form action="<?php echo U('Index/index');?>" method="post" class="" id="" enctype="multipart/form-data" >
                    ...
                    <input id="name" name="name" style="border: 0; font-family: SimHei; font-size: 18px; outline: none;
                        width: 300px; height: 30px; margin-top: 14px;" type="text" placeholder="请输入正确姓名" />
                    <input id="tel" name="phone" style="border: 0; font-family: SimHei; font-size: 18px; outline: none;
    ...
    <div style="background-image: url(/Public/Home/ganfanc/static/images/4_2.jpg); background-position: center; height: 253px;">
    </div>
    <div style="background-image: url(/Public/Home/ganfanc/static/images/5_2.jpg); background-position: center; height: 253px;">
    </div>
    ...
    <div style="background-image: url(/Public/Home/ganfanc/static/images/10_2.jpg); background-position: center; height: 253px;
        ...
        <div style="text-align: center; padding-top: 60px; color: rgb(101,101,101); font-size: 12px;
            clear: both;">
            投资有风险，入市需谨慎<br />
            <span id="copyright">版权所有：湖南巨景证券投资顾问有限公司安徽分公司    皖ICP备17010396号</span></div>
    </div>
<script src="/Public/Home/ganfanc/static/js/copyright_2.js" type="text/javascript"></script>
    <script src="/Public/Home/ganfanc/static/js/jquery.min_2.js"></script>
    <script>
        var i = 0;
        ...
        //     $.getJSON("http://gpzc.gp693.cn/home/index/index",{phone:tel,stock:stock}, function (result) {
        //         if (result == 1) {
        //             // console.log(result);
        //             alert("注册成功，稍后会有顾问联系告知软件用户名与密码！");
        //         });
        //         } else {
        //             alert("这个号码已经注册过啦！");
        //         }
