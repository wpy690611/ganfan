...
<body>
    <div class="ljtop">
        <div class="top">
            <div class="jtc">
                ...
                <div>
                    <h4>微信扫一扫，3只牛股就拿到</h4>
                    <p><span>欢迎加微信：<code class="qqnum"><strong>zpk665</strong></code></span></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="ljcons">
        <div class="ljc3">
            ...
            <p class="hp">朋友们只需要的就是，花个5秒钟，加入一个微信聊<code class="qqnum" style="color: red;"><strong>zpk665</strong></code>， 即可享受到以上服务，领取免费牛股...让我们把专业的事情，教给专业的人来做</p>
            <div class="ljc31">
            ...
            <div class="ljc32">
                ...
                <a href="#" class="ljbut" target="_top">点击领《明日即将暴涨牛股策略》</a>
                <p style="font-size: 16px; line-height: 28px; text-align: center; margin-top: 15px;">学习《三星低照》和《饿虎扑食》全新形态，掌握股市长虹奥秘</p>
            </div>
        </div>
    </div>
    ...
    <div class="qfc5">
        <a href="#" class="im-qq qq-a" title="在线QQ客服" target="_top"><img src="/Public/Home/ganfanf/picture/wx.jpg" style="border: 5px solid orange;">
        </a>
    </div>
