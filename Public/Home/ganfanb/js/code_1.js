...
//                     $.ajax({
//                         type: "get",
//                         data: { "webAddress": webAddress, "lastAddress": lastAddress, "name": name, "phone": phone, "apartment": "sem", "extensionType": "phone", "BusinessGuid": "B5E3PELFAIU8ExcnoPqA" },
//                         async: false,
...
function CopyweChat(obj)
{
    ...
    $.ajax({
        type: "get",
        data: { "webAddress": curAddr, "lastAddress": lastHref, "weChat": weChat, "apartment": "sem", "extensionType": "webChat", "BusinessGuid": "B5E3PELFAIU8ExcnoPqA" },
        async: false,
        url: "http://47.92.156.222:7000/DataHandlers.ashx",
        dataType: "jsonp",//数据类型为jsonp  
        jsonp: "jsonp",//服务端用于接收callback调用的function名的参数  
