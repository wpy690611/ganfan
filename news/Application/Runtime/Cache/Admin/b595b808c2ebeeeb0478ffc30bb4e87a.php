...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> 软文发布管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
		...
		<dl id="menu-picture">
			<dt><i class="Hui-iconfont">&#xe613;</i>我的财务管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="<?php echo U('Consume/consume');?>" data-title="消费财务报表" href="javascript:void(0)">消费财务报表</a></li>
			</ul>
		</dd>
	</dl>
</div>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="/news/Public/welcome.html"></iframe>
	</div>
</div>
</section>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/news/Public/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
