...
<div class="mt-20">
    <div>
        您当前的账户余额为：<span class="c-red"><?php echo ($balance); ?></span>元。
    </div>
    <table class="table table-border table-bordered table-bg table-hover table-sort">
        ...
        <tbody>
        <?php if(is_array($consume)): $i = 0; $__LIST__ = $consume;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
...
<script type="text/javascript" src="/news/Public/lib/laypage/1.2/laypage.js"></script>
